...
void print(LookupTable<T, X>& lt);

template <class T, class X>
void try_to_find(LookupTable<T, X>& lt, T key);
...
{
 //clear screen
 system("clear"); // this funtion only works under Linux/Unix
...
void test_Customer()
  ...
  {
    cout<<"\nCreating and testing LookupTable <int, Customer> .....\n";
    ...
    lt.insert(LookupTable<int, Customer>::Pair (8002, a));
    lt.insert(LookupTable<int, Customer>::Pair (8004,c));
    lt.insert(LookupTable<int, Customer>::Pair (8001,b));
    ...
    cout << "***----Finished Lab 8 tests on <int, Customer>-----***\n";
...
void test_String()
  ...
  // creating lookuptable for Mystring objects
  {
    ...
    lt.insert(LookupTable<int, Mystring>::Pair (8002,a));
    lt.insert(LookupTable<int, Mystring>::Pair (8001,b));
    lt.insert(LookupTable<int, Mystring>::Pair (8004,c));
